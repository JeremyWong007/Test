...
function copyToJinke0651(){
    #sshpass -p 'gold' scp -o StrictHostKeyChecking=no -o ConnectTimeout=3 -r $SRC_PATH  root@192.168.101.240:/home/gold/
    #scp -o StrictHostKeyChecking=no -o ConnectTimeout=3 -r $SRC_PATH  gold@172.18.10.203:/home/gold/
    for((i=0;i<${#JinkeHost[@]};i++)); do
    {
        scp -o StrictHostKeyChecking=no -o ConnectTimeout=3 -r $SRC_PATH  gold@${JinkeHost[$i]}:/home/gold/
    }
    done
}
